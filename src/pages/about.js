...
const EDUCATION = [
    {
        ...
        description: 'Graduada con honores',
    },
    {
        title      : 'Ingeniería de Software',
        institution: 'Universidad Católica Boliviana "San Pablo"',
        description: 'Estudiante de 5to semestre con Beca STEM (Santa Cruz).',
    },
    {
        title      : 'AWS Cloud Club Captain',
        institution: 'Amazon Web Services (AWS)',
        description: 'Liderazgo de comunidad estudiantil, organización de eventos técnicos y gestión de equipos core.',
    },
];
...
export function aboutPage() {
    ...
    const educationHTML = renderTemplate('tpl-education-card', { education: EDUCATION });
    ...
    section.innerHTML = `
        <div class="container">
            ...
            <div class="about__section">
                <h4>Educación</h4>
                <!-- Handlebars renderiza estas cards desde #tpl-education-card -->
